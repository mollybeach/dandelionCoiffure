...
urlpatterns = [
    ...
    distill_path('clients.html', views.clients, name='clients', distill_func=get_none),
    distill_path('register.html', views.register, name='register', distill_func=get_none),
    distill_path('login.html', views.login, name='login', distill_func=get_none),
    distill_path('profile.html', views.profile, name='profile', distill_func=get_none),
    distill_path('calendar.html', views.calendar, name='calendar', distill_func=get_none),
